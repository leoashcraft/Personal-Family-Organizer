...
-- Note, the password has used here will be "password" in plain text.
INSERT INTO `users` (`user_id`, `username`, `email`, `first_name`, `last_name`, `password_hash`) VALUES
(1, 'leo', 'user@email.com', 'Leo', 'Ashcraft', '$2a$10$qAVq73R9OredJ5yoHaZN4OQ4wFLfzQHFz3YlP.39bu0IVFOhGG6Ou');
